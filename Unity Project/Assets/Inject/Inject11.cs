...
public class Inject11: MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isSyriInVirus && YandexGame.savesData.virus == 11)
        {
            // Обработка ввода клавиши "e" или кнопки GUI
            if (Input.GetKeyDown(KeyCode.F) || (gui != null && gui.onClick != null))
            {
                YandexGame.savesData.transform = 1;
                YandexGame.savesData.virus = 0;
                Debug.Log("Клавиша F или кнопка GUI нажата. YandexGame.savesData.virus установлено в 1.");
